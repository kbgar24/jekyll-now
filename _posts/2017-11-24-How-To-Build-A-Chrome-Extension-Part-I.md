...
```
The *matches* properties defines on which domains the **content scripts** should be injected. Of note, _&58;<all_urls>_ is the expression for injecting your **content scripts** into all pages the User might visit.
